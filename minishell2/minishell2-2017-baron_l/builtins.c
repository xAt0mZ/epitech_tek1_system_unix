...
** Last update Tue Mar  5 09:34:01 2013 louis-philippe baron
*/
...
int		exec_builtin(char **command, t_list *list)
{
  int		i;
  int		(*builtins[5])(char **, t_list *);
  ...
  if (builtins[i](command, list) == ERROR)
    return (ERROR);
  return (0);
}
